...
if (!$arena instanceof Arena) {
    $heracles = new Hero('Heracles', 30, 6, 'heracles.svg', 1000);
    $horse1 = new Monster('Mare 1', 25, 12, 'horse.svg', 500);
    $horse2 = new Monster('Mare 2', 25, 12, 'horse.svg', 500);
    $horse3 = new Monster('Mare 3', 25, 12, 'horse.svg', 500);
    $horse4 = new Monster('Mare 4', 25, 12, 'horse.svg', 500);
